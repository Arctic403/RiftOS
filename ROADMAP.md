...
- **N3 Architecture/impact engine — N3.0 CONTRACT/BASELINE SOURCE IMPLEMENTED; BUILDER + INSTALL + LIVE PROOF PENDING; N3.1-N3.6 BLOCKED.** N1.8, N2.0-N2.12, the full Batch V2 restoration chain and the N3 machine-authority prelude are satisfied. N3.0 freezes the machine contract, authority boundaries, existing PI-v2 input schemas, bounded resource ceilings, correctness corpus, zero-tolerance rules and macro implementation plan before engine code starts. N3 is analysis-only: it cannot plan, mutate, authorize, grant capabilities or activate the canonical N2 memory runtime. Full specification: `docs/systems/riftcli/N3_ARCHITECTURE_IMPACT_ROADMAP.md`.
