        ...
        return when (command) {
            "help" -> ShellOutcome(
                "Native RiftShell core\n" +
                    ...
                    "riftbuild doctor|validate|plan|prepare-riftpp-v0|prepare-codynex-mc0|prepare-codynex-mc1a|prepare-codynex-mc1b|prepare-codynex-m2-vm0|prepare-codynex-m2b|prepare-codynex-mc2a|pack|sign|verify|install-proof|install-status|launch-proof|runs|artifacts   [NATIVE / BOUNDED]\n" +
