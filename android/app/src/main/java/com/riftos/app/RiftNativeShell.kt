        ...
        return when (command) {
            "help" -> ShellOutcome(
                "Native RiftShell core\n" +
                    ...
                    "riftbuild doctor|validate|plan|prepare-riftpp-v0|prepare-codynex-mc0|prepare-codynex-mc1a|pack|sign|verify|install-proof|install-status|launch-proof|runs|artifacts   [NATIVE / BOUNDED]\n" +
