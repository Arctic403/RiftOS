...
(() => {
    ...
    function renderTabs() {
        ...
        openTabs.forEach(path => {
            ...
            // Separate close listener is important on iOS Safari. Keeping the
            // close action inside the parent tab click caused the same tap to
            // be observed by the global/file-selection handlers as well.
