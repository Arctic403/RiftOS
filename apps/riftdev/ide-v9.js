...
(() => {
    ...
    const IDE_VERSION = "RiftCity-IDE-v9";
    ...
    function renderTabs() {
        ...
        openTabs.forEach(path => {
            ...
            tab.innerHTML = `
                <span class="ide-tab-name">${escapeHtml(basename(path))}</span>
    ...
    function watchActiveFile() {
        ...
        document.addEventListener(
            "click",
            () => {
                requestAnimationFrame(registerCurrentFile);
            },
            true
        );
    }
