...
**Foundation content truth, producer provenance and Patch 10.35 restart-order determinism are live-proven, but N1.8.0 remains blocked: the continuing torture audit found that PI cache v4 did not integrity-seal its persisted semantic payload. Patch 10.36 upgrades PI persistence to integrity-sealed schema v5; Builder/install/restart v5 proof is required before promotion.**
