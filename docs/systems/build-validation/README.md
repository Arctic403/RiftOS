...
Current Android source directory contains 45 Kotlin files.

android/app/build.gradle.kts::verifyRiftOsAndroidSources now explicitly lists all 45.
...
Because the Gradle list is now exact 45/45, the Builder consumes the same mandatory native snapshot rather than maintaining another stale source list.
