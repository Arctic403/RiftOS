...
- `riftmemory/n2-phase-authority.json` preserves N2.0-N2.2 promoted with N2.1 and N2.2 carrying their separate run-346 promotion evidence, N2-M1 promoted, N2.3 + N2.4 source-implemented under N2-M2 promotion-pending, N2.5-N2.12 pending, and the six-macro N2.1-N2.11 execution plan without merging per-phase authority;
