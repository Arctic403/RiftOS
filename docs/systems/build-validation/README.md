...
- the N2.12-before-N3 barrier and N3.0 promotion gate are satisfied; N3-M1 remains temporarily blocked only until the hidden read-only PI bridge is Builder/install-proven, after which N3.1+ moves into replaceable `/workspace/.riftcli/` intelligence.
