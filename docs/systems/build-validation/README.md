...
- `riftmemory/n2-phase-authority.json` preserves N2.0-N2.8 promoted with N2.1 + N2.2 carrying run-346 promotion evidence, N2.3 + N2.4 carrying installed source `18f1156075e08cb94573a9392031ac64552313f2` / run-350 evidence, N2.5 + N2.6 carrying installed source `62382a94f50dd6052e1754c1496da2a0f794c0af` / run-355 evidence, and N2.7 + N2.8 carrying installed source `d39960832a701311461058670b5b93597ae612c9` / run-368 evidence; N2-M1 + N2-M2 + N2-M3 + N2-M4 are promoted, N2.9 / N2-M5 is `source-implemented` with null promoted source/run, N2.10-N2.12 remain pending, and the six-macro N2.1-N2.11 execution plan preserves separate per-phase authority;
