...
- `riftmemory/n2-phase-authority.json` preserves N2.0-N2.6 promoted with N2.1 + N2.2 carrying run-346 promotion evidence, N2.3 + N2.4 carrying installed source `18f1156075e08cb94573a9392031ac64552313f2` / run-350 promotion evidence, and N2.5 + N2.6 carrying installed source `62382a94f50dd6052e1754c1496da2a0f794c0af` / run-355 promotion evidence; N2-M1 + N2-M2 + N2-M3 are promoted, N2.7 + N2.8 / N2-M4 are `source-implemented` with null promoted source/run, N2.9-N2.12 remain pending, and the six-macro N2.1-N2.11 execution plan preserves separate per-phase authority;
