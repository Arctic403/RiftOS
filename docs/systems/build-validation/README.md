...
- `riftmemory/n2-phase-authority.json` preserves N2.0-N2.4 promoted with N2.1 + N2.2 carrying run-346 promotion evidence and N2.3 + N2.4 carrying installed source `18f1156075e08cb94573a9392031ac64552313f2` / run-350 promotion evidence, N2-M1 + N2-M2 promoted, N2.5 + N2.6 source-implemented under N2-M3 promotion-pending, N2.7-N2.12 pending, and the six-macro N2.1-N2.11 execution plan without merging per-phase authority;
