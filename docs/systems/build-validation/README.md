...
- `riftmemory/n2-phase-authority.json` preserves N2.0-N2.9 promoted with N2.1 + N2.2 carrying run-346 promotion evidence, N2.3 + N2.4 carrying installed source `18f1156075e08cb94573a9392031ac64552313f2` / run-350 evidence, N2.5 + N2.6 carrying installed source `62382a94f50dd6052e1754c1496da2a0f794c0af` / run-355 evidence, N2.7 + N2.8 carrying installed source `d39960832a701311461058670b5b93597ae612c9` / run-368 evidence, and N2.9 carrying installed source `d650e57dff09a878f02edfef7e175ed02d42f750` / run-370 evidence; N2-M1 + N2-M2 + N2-M3 + N2-M4 + N2-M5 are promoted, N2.10 + N2.11 / N2-M6 are source-implemented with null promoted source/run, N2.12 remains pending, and the six-macro N2.1-N2.11 execution plan preserves separate per-phase authority;
...
- `scripts/test-rift-memory-n2-m6-v1.mjs` independently gates N2.10 independent RiftStore/SQLite interface conformance and N2.11 integrity/poisoning/crash/restart/resource hardening, including mandatory M6 source ownership, AtomicFile whole-state sealing and pre-read bounds, exact three-lane `rift_info` diagnostics, dual `arm64-v8a`/`armeabi-v7a` build targets, inactive runtime authority, SQLite-reference preservation and explicit benchmark deferral; Builder/install/restart evidence is required before promotion;
