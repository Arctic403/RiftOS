...
| N3 Architecture/Impact Engine | **N3-M1 PROMOTED / N3-M2 READY** | [`systems/riftcli/N3_ARCHITECTURE_IMPACT_ROADMAP.md`](systems/riftcli/N3_ARCHITECTURE_IMPACT_ROADMAP.md) | Run-390 contract + run-391 hidden PI bridge promoted; N3.1+ now runs in replaceable `/workspace/.riftcli/` intelligence |
