...
| Repository Consistency Observer | **N1.8.0 SOURCE / TORTURE GATE PENDING** | [`systems/workspace/REPOSITORY_CONSISTENCY_OBSERVER.md`](systems/workspace/REPOSITORY_CONSISTENCY_OBSERVER.md) | content-bound graph v2 + PI cache v4 producer provenance implemented; installed cache-rejection/rebuild + remaining adversarial promotion matrix required; staged subsystem planner design-locked but not implemented until pass |
