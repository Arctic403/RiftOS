...
| N3 Architecture/Impact Engine | **N3.0 PROMOTED / N3-M1 READY** | [`systems/riftcli/N3_ARCHITECTURE_IMPACT_ROADMAP.md`](systems/riftcli/N3_ARCHITECTURE_IMPACT_ROADMAP.md) | Frozen bounded analysis-only contract promoted on run 390; N3.1+ moves into replaceable `/workspace/.riftcli/` intelligence |
