...
| N3 Architecture/Impact Engine | **N3.0 SOURCE IMPLEMENTED** | [`systems/riftcli/N3_ARCHITECTURE_IMPACT_ROADMAP.md`](systems/riftcli/N3_ARCHITECTURE_IMPACT_ROADMAP.md) | Frozen bounded analysis-only contract; N3.1-N3.6 blocked pending N3.0 promotion |
