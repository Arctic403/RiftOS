...
| Repository Consistency Observer | **N1.8.0 SOURCE / TORTURE GATE PENDING** | [`systems/workspace/REPOSITORY_CONSISTENCY_OBSERVER.md`](systems/workspace/REPOSITORY_CONSISTENCY_OBSERVER.md) | full-repo fact/graph/cache foundation implemented; installed adversarial promotion matrix required; staged subsystem planner design-locked but not implemented until pass |
