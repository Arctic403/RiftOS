...
Builder compilation/signed-DEX proof of the identity split, installed create→delete parity, restart continuity, remaining N1.8.5 bounds/fixture matrix and N1.8.0-N1.8.4 continuity remain required before N1.8.5 promotion.
