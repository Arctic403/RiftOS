...
| `android/app/src/main/java/com/riftos/app/RiftCliRecoveryPolicy.kt` | `docs/systems/riftcli/README.md` + `ROADMAP.md` + `docs/PROJECT_STATUS.md` + `docs/PATCH_HISTORY.md` + `docs/systems/build-validation/README.md` |
...
| `android/app/src/main/java/com/riftos/app/RiftToolHost.kt` | `docs/systems/mcp/tool-host/README.md` + `docs/systems/engine/README.md` + `docs/systems/riftmemory/README.md` + `docs/systems/build-validation/README.md` |
...
| `android/app/src/main/java/com/riftos/app/RiftProofObligationsV1.kt` | `docs/systems/workspace/REPOSITORY_CONSISTENCY_OBSERVER.md` + `docs/systems/mcp/sandbox/README.md` + `docs/systems/build-validation/README.md` + `docs/PATCH_HISTORY.md` + `docs/PROJECT_STATUS.md` |
| `android/app/src/main/java/com/riftos/app/RiftMemoryModelV1.kt` | `docs/systems/riftmemory/N2_FEDERATED_MEMORY_ROADMAP.md` + `docs/systems/riftmemory/README.md` + `docs/systems/build-validation/README.md` + `docs/PATCH_HISTORY.md` + `docs/PROJECT_STATUS.md` |
| `android/app/src/main/java/com/riftos/app/RiftMemoryStoreV1.kt` | `docs/systems/riftmemory/N2_FEDERATED_MEMORY_ROADMAP.md` + `docs/systems/riftmemory/README.md` + `docs/systems/build-validation/README.md` + `docs/PATCH_HISTORY.md` + `docs/PROJECT_STATUS.md` |
| `android/app/src/main/java/com/riftos/app/RiftSqliteMemoryStoreV1.kt` | `docs/systems/riftmemory/N2_FEDERATED_MEMORY_ROADMAP.md` + `docs/systems/riftmemory/README.md` + `docs/systems/build-validation/README.md` + `docs/PATCH_HISTORY.md` + `docs/PROJECT_STATUS.md` |
| `android/app/src/main/java/com/riftos/app/RiftMemoryN2M1SelfTest.kt` | `docs/systems/riftmemory/N2_FEDERATED_MEMORY_ROADMAP.md` + `docs/systems/riftmemory/README.md` + `docs/systems/build-validation/README.md` + `docs/PATCH_HISTORY.md` + `docs/PROJECT_STATUS.md` |
| `android/app/src/main/java/com/riftos/app/RiftMemoryReconciliationV1.kt` | `docs/systems/riftmemory/N2_FEDERATED_MEMORY_ROADMAP.md` + `docs/systems/riftmemory/README.md` + `docs/systems/build-validation/README.md` + `docs/PATCH_HISTORY.md` + `docs/PROJECT_STATUS.md` |
| `android/app/src/main/java/com/riftos/app/RiftMemoryTemporalGraphV1.kt` | `docs/systems/riftmemory/N2_FEDERATED_MEMORY_ROADMAP.md` + `docs/systems/riftmemory/README.md` + `docs/systems/build-validation/README.md` + `docs/PATCH_HISTORY.md` + `docs/PROJECT_STATUS.md` |
| `android/app/src/main/java/com/riftos/app/RiftMemoryN2M2SelfTest.kt` | `docs/systems/riftmemory/N2_FEDERATED_MEMORY_ROADMAP.md` + `docs/systems/riftmemory/README.md` + `docs/systems/build-validation/README.md` + `docs/PATCH_HISTORY.md` + `docs/PROJECT_STATUS.md` |
| `android/app/src/main/java/com/riftos/app/RiftMemoryConsolidationV1.kt` | `docs/systems/riftmemory/N2_FEDERATED_MEMORY_ROADMAP.md` + `docs/systems/riftmemory/README.md` + `docs/systems/build-validation/README.md` + `docs/PATCH_HISTORY.md` + `docs/PROJECT_STATUS.md` |
| `android/app/src/main/java/com/riftos/app/RiftMemoryBeliefDifferenceV1.kt` | `docs/systems/riftmemory/N2_FEDERATED_MEMORY_ROADMAP.md` + `docs/systems/riftmemory/README.md` + `docs/systems/build-validation/README.md` + `docs/PATCH_HISTORY.md` + `docs/PROJECT_STATUS.md` |
| `android/app/src/main/java/com/riftos/app/RiftMemoryN2M3SelfTest.kt` | `docs/systems/riftmemory/N2_FEDERATED_MEMORY_ROADMAP.md` + `docs/systems/riftmemory/README.md` + `docs/systems/build-validation/README.md` + `docs/PATCH_HISTORY.md` + `docs/PROJECT_STATUS.md` |
| `android/app/src/main/java/com/riftos/app/RiftMemoryProceduralFailureV1.kt` | `docs/systems/riftmemory/N2_FEDERATED_MEMORY_ROADMAP.md` + `docs/systems/riftmemory/README.md` + `docs/systems/build-validation/README.md` + `docs/PATCH_HISTORY.md` + `docs/PROJECT_STATUS.md` |
| `android/app/src/main/java/com/riftos/app/RiftMemoryRetrievalContextV1.kt` | `docs/systems/riftmemory/N2_FEDERATED_MEMORY_ROADMAP.md` + `docs/systems/riftmemory/README.md` + `docs/systems/build-validation/README.md` + `docs/PATCH_HISTORY.md` + `docs/PROJECT_STATUS.md` |
| `android/app/src/main/java/com/riftos/app/RiftMemoryN2M4SelfTest.kt` | `docs/systems/riftmemory/N2_FEDERATED_MEMORY_ROADMAP.md` + `docs/systems/riftmemory/README.md` + `docs/systems/build-validation/README.md` + `docs/PATCH_HISTORY.md` + `docs/PROJECT_STATUS.md` |
| `android/app/src/main/java/com/riftos/app/RiftMemoryObserverValidatorLoopV1.kt` | `docs/systems/riftmemory/N2_FEDERATED_MEMORY_ROADMAP.md` + `docs/systems/riftmemory/README.md` + `docs/systems/build-validation/README.md` + `docs/PATCH_HISTORY.md` + `docs/PROJECT_STATUS.md` |
| `android/app/src/main/java/com/riftos/app/RiftMemoryN2M5SelfTest.kt` | `docs/systems/riftmemory/N2_FEDERATED_MEMORY_ROADMAP.md` + `docs/systems/riftmemory/README.md` + `docs/systems/build-validation/README.md` + `docs/PATCH_HISTORY.md` + `docs/PROJECT_STATUS.md` |
| `android/app/src/main/java/com/riftos/app/RiftStoreMemoryStoreV1.kt` | `docs/systems/riftmemory/N2_FEDERATED_MEMORY_ROADMAP.md` + `docs/systems/riftmemory/README.md` + `docs/systems/build-validation/README.md` + `docs/PATCH_HISTORY.md` + `docs/PROJECT_STATUS.md` |
| `android/app/src/main/java/com/riftos/app/RiftMemoryN2M6SelfTest.kt` | `docs/systems/riftmemory/N2_FEDERATED_MEMORY_ROADMAP.md` + `docs/systems/riftmemory/README.md` + `docs/systems/build-validation/README.md` + `docs/PATCH_HISTORY.md` + `docs/PROJECT_STATUS.md` |
| `android/app/src/main/java/com/riftos/app/RiftMemoryN2FinalSelfTest.kt` | `docs/systems/riftmemory/N2_FEDERATED_MEMORY_ROADMAP.md` + `docs/systems/riftmemory/README.md` + `docs/systems/build-validation/README.md` + `docs/PATCH_HISTORY.md` + `docs/PROJECT_STATUS.md` |
...
| `scripts/test-rift-proof-obligations-v1.mjs` | `docs/systems/build-validation/README.md` + `docs/systems/mcp/sandbox/README.md` + `docs/systems/workspace/REPOSITORY_CONSISTENCY_OBSERVER.md` + `docs/PATCH_HISTORY.md` + `scripts/README.md` |
| `scripts/test-rift-observer-adversarial-v1.mjs` | `docs/systems/build-validation/README.md` + `docs/systems/workspace/REPOSITORY_CONSISTENCY_OBSERVER.md` + `docs/PROJECT_STATUS.md` + `docs/PATCH_HISTORY.md` + `scripts/README.md` |
| `scripts/test-rift-memory-n2-contract-v1.mjs` | `docs/systems/build-validation/README.md` + `docs/systems/riftmemory/N2_FEDERATED_MEMORY_ROADMAP.md` + `docs/systems/riftmemory/README.md` + `docs/PROJECT_STATUS.md` + `docs/PATCH_HISTORY.md` + `scripts/README.md` |
| `scripts/test-rift-memory-n2-m1-v1.mjs` | `docs/systems/build-validation/README.md` + `docs/systems/riftmemory/N2_FEDERATED_MEMORY_ROADMAP.md` + `docs/systems/riftmemory/README.md` + `docs/PROJECT_STATUS.md` + `docs/PATCH_HISTORY.md` + `scripts/README.md` |
| `scripts/test-rift-memory-n2-m2-v1.mjs` | `docs/systems/build-validation/README.md` + `docs/systems/riftmemory/N2_FEDERATED_MEMORY_ROADMAP.md` + `docs/systems/riftmemory/README.md` + `docs/PROJECT_STATUS.md` + `docs/PATCH_HISTORY.md` + `scripts/README.md` |
| `scripts/test-rift-memory-n2-m3-v1.mjs` | `docs/systems/build-validation/README.md` + `docs/systems/riftmemory/N2_FEDERATED_MEMORY_ROADMAP.md` + `docs/systems/riftmemory/README.md` + `docs/PROJECT_STATUS.md` + `docs/PATCH_HISTORY.md` + `scripts/README.md` |
| `scripts/test-rift-memory-n2-m4-v1.mjs` | `docs/systems/build-validation/README.md` + `docs/systems/riftmemory/N2_FEDERATED_MEMORY_ROADMAP.md` + `docs/systems/riftmemory/README.md` + `docs/PROJECT_STATUS.md` + `docs/PATCH_HISTORY.md` + `scripts/README.md` |
...
| `scripts/test-rift-cli-authority-convergence.mjs` | `docs/systems/build-validation/README.md` + `docs/systems/riftcli/README.md` + `ROADMAP.md` |
