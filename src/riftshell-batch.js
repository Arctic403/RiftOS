...
const NON_REVERSIBLE=new Set(["git","gh","github","mount","umount","kill","open","browser","batch","vortex","vortex-agent","riftos-agent","riftllm-agent","rift-cli","chat","devlab","rift"]);
