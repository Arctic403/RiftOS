(() => {
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      body.riftos-riftdev{margin:0}
      body.riftos-riftdev .app-container{min-height:100dvh;height:100dvh}
      body.riftos-riftdev .app-header{padding-top:max(8px,env(safe-area-inset-top));}
      .riftos-devbar{display:flex;gap:7px;align-items:center;flex-wrap:wrap;padding:7px 8px;border-bottom:1px solid #303742;background:#0c1118;position:sticky;top:0;z-index:1500}
      ...
      .riftos-actions-body{flex:1;min-height:0;overflow:auto}
  ...
  function installBar() {
    ...
    bar.innerHTML = `
      ...
      <button class="riftos-devbtn" id="riftDevExitBtn" type="button">Exit</button>`;
    ...
    $("riftDevExitBtn").onclick = () => window.parent.postMessage({ type: "riftdev:close" }, location.origin);
  }
