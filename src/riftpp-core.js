...
export const RIFTPP_CORE_VERSION='0.9.0-bootstrap';
...
const PRELUDE_NAMES=new Set(['print','value_sha256',...CHECKPOINT_BUILTINS,...STRING_BUILTINS,...TEXT_BUILTINS,...NUMERIC_TEXT_BUILTINS,...REPAIR_BUILTINS,...SOFTWARE_BUILTINS]);
