...
if (n2PhaseAuthority.schema !== 'rift-memory-n2-phase-authority-v1' ||
    n2PhaseAuthority.programStatus !== 'N2.0-N2.8 PROMOTED / N2-M1 + N2-M2 + N2-M3 + N2-M4 PROMOTED; N2.9 SOURCE IMPLEMENTED / N2-M5 SOURCE IMPLEMENTED; N2.10-N2.12 PENDING' ||
    n2PhaseAuthority.runtimeStatus !== 'N2 CANONICAL MEMORY RUNTIME INACTIVE; N2-M1 + N2-M2 + N2-M3 + N2-M4 PROMOTED DIAGNOSTICS; N2-M5 SOURCE-IMPLEMENTED DIAGNOSTIC ONLY' ||
    ...
    n2PhaseAuthority.phases?.[9]?.promotedSourceSha !== null ||
    n2PhaseAuthority.phases?.[9]?.builderRunNumber !== null ||
    n2PhaseAuthority.phases?.slice(10).some(row => row.status !== 'pending' || row.promotedSourceSha !== null || row.builderRunNumber !== null) ||
    ...
    n2PhaseAuthority.macroImplementationPlan?.[5]?.status !== 'pending' ||
...
if (!rootRoadmap.includes('N2 Federated Rift Memory Kernel — N2.0-N2.8 PROMOTED / N2-M1 + N2-M2 + N2-M3 + N2-M4 PROMOTED; N2.9 SOURCE IMPLEMENTED / N2-M5 SOURCE IMPLEMENTED; N2.10-N2.12 PENDING; CANONICAL MEMORY RUNTIME INACTIVE') ||
