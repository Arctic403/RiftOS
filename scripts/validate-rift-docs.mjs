...
if (n2PhaseAuthority.schema !== 'rift-memory-n2-phase-authority-v1' ||
    n2PhaseAuthority.programStatus !== 'N2.0-N2.4 PROMOTED / N2-M1 + N2-M2 PROMOTED; N2.5-N2.12 PENDING' ||
...
if (!rootRoadmap.includes('N2 Federated Rift Memory Kernel — N2.0-N2.4 PROMOTED / N2-M1 + N2-M2 PROMOTED; N2.5-N2.12 PENDING; CANONICAL MEMORY RUNTIME INACTIVE') ||
