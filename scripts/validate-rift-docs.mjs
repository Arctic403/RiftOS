...
if (n2PhaseAuthority.schema !== 'rift-memory-n2-phase-authority-v1' ||
    n2PhaseAuthority.programStatus !== 'N2.0-N2.2 PROMOTED / N2-M1 PROMOTED; N2.3-N2.12 PENDING' ||
...
if (!rootRoadmap.includes('N2 Federated Rift Memory Kernel — N2.0-N2.2 PROMOTED / N2-M1 PROMOTED; N2.3-N2.12 PENDING; CANONICAL MEMORY RUNTIME INACTIVE') ||
