...
for (const required of ['SEMNEXIS_NATIVE_IR_V0', 'SNIRV0', 'SNIRV2', 'SNIRV3', 'SNIRV4', 'SNIRV5', 'SNIRV6', 'zext.u8.i32', 'Slice<u8>', 'slice.len', 'slice.get.u8', 'record.make', 'record.get', 'ret.record', 'phi.record', 'MAX_SEMNEXIS_FLAT_RECORD_WORDS', 'arm32LdrbReg', 'MAX_SEMNEXIS_TYPE_DEPTH', 'SEMNEXIS_ARM32_ELF_PROOF_V0', 'SEMNEXIS_ARM32_RUNTIME_ELF_V0', 'verifyNativeIREffectsAndCapabilities', 'verifyArm32RuntimeElfStructureV0', 'source IR is required for canonical verification', 'MAX_SEMNEXIS_SOURCE_CHARS', 'MAX_SEMNEXIS_EXPRESSION_DEPTH', 'MAX_SEMNEXIS_CFG_BLOCKS', 'MAX_ARM32_RUNTIME_ELF_BYTES', 'advisory-correlation-id-v0', 'linear-scan-r4-r7-v0', 'cfg-spill-v0', 'verifyNativeIRControlFlow', 'phi.i32', 'br.cmp.lt', 'loop_backedge', 'buildArm32RuntimeDivHelperV0', "checkedArithmetic:['add','sub','mul','div']", 'constantEvaluated:false', 'runtimeLowered:true', 'generated-artifact-not-executed-from-riftfs']) {
...
for (const required of ['MAX_SEMNEXIS_SOURCE_BYTES', 'MAX_SEMNEXIS_OUTPUT_CHARS', 'semnexis-bootstrap-self-test/13', 'sliceIrBinaryFormat', 'arm32SliceBytes', 'recordIrBinaryFormat', 'arm32RecordBytes', 'projectionIrBinaryFormat', 'arm32ProjectionBytes', 'recordConditionalIrBinaryFormat', 'arm32RecordConditionalBytes', 'recordLoopIrBinaryFormat', 'arm32RecordLoopBytes', 'decimalIrBinaryFormat', 'arm32DecimalBytes', 'decimalZextCount', 'hardeningDerivedEffects', 'hardeningCanonicalMachineVerify', 'hardeningExpressionBudget']) {
