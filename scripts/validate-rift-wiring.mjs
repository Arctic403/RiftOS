...
if (!entry.includes('import("./riftpp-core.js")') || !riftppCore.includes("RIFTPP_LANGUAGE='riftpp/1'") || !riftppCore.includes("RIFTPP_CORE_VERSION='0.3.0-bootstrap'") || !riftppCore.includes('compileRiftPlusPlusCoreV1') || !riftppCore.includes('prepareRiftExecutable(executable)') || !riftppCore.includes('compileWhile') || !riftppCore.includes('compileIf') || !riftppCore.includes('compileMatch') || !riftppCore.includes('structDecl()') || !riftppCore.includes('enumDecl()') || !riftppCore.includes("'+=','-=','*=','/=','%='") || !riftppCore.includes('globalThis.RiftPlusPlusCore=Object.freeze')) failures.push('Rift++ Core bootstrap compiler wiring is incomplete');
