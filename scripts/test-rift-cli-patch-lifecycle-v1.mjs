...
const verification = read(k + 'RiftVerificationPlannerV1.kt');
...
assert.match(verification, /rift\.verification-plan\/1/);
assert.match(verification, /rift\.verification-evidence\/1/);
