...
- `test-semnexis-bootstrap.mjs` — executes the QuickJS-hosted Semnexis compiler against graph/plan/Native-IR goldens, `SNIRV0` binary round-trip/corruption checks, checked-i32 semantics and the direct ARM32 ELF proof backend.
