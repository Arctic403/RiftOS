...
for (const marker of [
  ...
  'RiftSourceIntelligenceV2.referenceCodeMask(test.path, test.text)',
  'codeMask.getOrNull(direct.range.first)',
  'codeMask.getOrNull(loop.range.first)',
  ...
  'regression-discovery-pattern',
  'regression-discovery-pattern-empty',
  'claims-regression-discovery-bound',
